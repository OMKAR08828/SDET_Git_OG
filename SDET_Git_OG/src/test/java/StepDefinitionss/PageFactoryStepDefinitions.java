 ...
 * 
 * import PageObjects.loginPageObjects; import io.cucumber.java.en.And; import
 * io.cucumber.java.en.Given; import io.cucumber.java.en.Then; import
 * io.cucumber.java.en.When;
 * 
 * public class PageFactoryStepDefinitions {
 * 
 ...
 * login=new loginPageObjects(driver); login.enterUsername(Username);
 * login.enterPassword(password); }
 * 
 * @And("Click on login button") public void click_on_login_button() {
 * login.clickOnLogin(); }
 * 
 * @Then("User should logged in successfully") public void
 * user_should_logged_in_successfully() { login.verifyHomepage(); }
 * 
