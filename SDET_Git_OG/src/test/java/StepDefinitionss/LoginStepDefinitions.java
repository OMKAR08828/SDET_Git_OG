...
public class LoginStepDefinitions {
	...
	public void user_enters_username_and_password(String string, String string1) {
		// Enter username
	...
	public void user_should_logged_in_successfully() {
		System.out.println(driver.findElement(By.className("shopping_cart_container")).isDisplayed());
